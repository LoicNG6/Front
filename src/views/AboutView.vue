<template>
  ...
  <VContainer fluid class="px-8">
    <VRow justify="center" class="my-4" style="text-align:center;">
      ...
      <VCol cols="5">
        blabblfmdjlkqjfmlkd qfldkfjmlsjfmlsjf dkfmsjsdf)fikopajd,v
        kjlmdjfmfkdlfjoijfaôjdfjdjlkjfdkfjpzaklcvlnojvnbhuoifrf
      </VCol>
    </VRow>
    <VDivider></VDivider>
    ...
    <VDivider></VDivider>
    <VRow justify="center" style="text-align:center;">
      <VCol cols="12">
